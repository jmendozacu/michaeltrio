...
Product.ConfigurableSwatches.prototype = {
    ...
    setStockData: function() {
        var cartBtn = $$('.add-to-cart button.btn-cart');
        this._E.cartBtn = {
            btn: cartBtn,
            txt: cartBtn.invoke('readAttribute', 'title'),
            //txt: cartBtn.invoke('readAttribute', 'data-button'),
    ...
    setStockStatus: function(inStock) {
        if (inStock) {
            ...
            this._E.cartBtn.btn.each(function(el, index) {
                ...
                //el.writeAttribute('data-button', Translator.translate(this._E.cartBtn.txt[index]));
                el.title = Translator.translate('Add to cart');
