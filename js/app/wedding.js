...
//    });
    ...
    function loadRingsContentOnScroll() {
        ...
        if (sourceArray.page < sourceArray.pages) {
            ...
            var requestUrl = BASE_URL + 'diamonds/ajax/filterweddingring/';
    ...
    function renderwithPriceContent(inputData, isFiltering) {
        ...
        if (inputData.total_count > 0) {
            ...
            inputData.objects.each(function (product) {
                ...
                output += '<li class="itemwedding  hover-effect first img-product-img-' + product.entity_id + '" style="">' +
...
//                   sourceArray.colours = $(this).attr('data-value');
//                }
            ...
            case 'style':
                ...
                {
                    $(this).addClass('checked');
                    sourceArray.style = $(this).attr('data-value');
                }
