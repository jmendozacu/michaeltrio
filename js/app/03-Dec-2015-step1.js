...
jQuery(document).ready(function(e) {
	...
	var	diamondsParamsURL = {
			...
			function getDiamondsContent( params, isFiltering ){
				...
				jQuery.post(localpath+'/diamonds/ajax/filter/' , 
						params , 
						function(data){
							data = JSON.parse(data);
			...
			function renderFilteredElements( inputArray , isFiltering ){
				...
				inputArray.each(function(entry){
					...
					cut = stepsOfGood( entry.cut );
					polish = stepsOfGood( entry.polish );
					symmetry = stepsOfGood( entry.symmetry );

					var diamondPrice = parseFloat( entry.diamonds_price );
					diamondPrice = diamondPrice.toFixed(2);

					var depth = parseFloat( entry.depth );
					depth = depth.toFixed(2);


					var shape = entry.shape;
					var imgUrl = 'http://michaeltrio.qoobx.com/skin/frontend/base/default/packer/images/diamonds/round.png';
					if( shape == 'RD'){
						shape = 'ROUND';
						imgUrl = 'http://michaeltrio.qoobx.com/skin/frontend/base/default/packer/images/diamonds/round.png';
					} else if( shape == 'PS' ){
						shape = 'Princess';
						imgUrl = 'http://michaeltrio.qoobx.com/skin/frontend/base/default/packer/images/diamonds/princess.png';
					} else if( shape == 'EC' ){
						shape = 'Emerald';
						imgUrl = 'http://michaeltrio.qoobx.com/skin/frontend/base/default/packer/images/diamonds/emerald.png';
					} else if( shape == 'HS' ){
						shape = 'Heart';
						imgUrl = 'http://michaeltrio.qoobx.com/skin/frontend/base/default/packer/images/diamonds/heart.png';
					}  else if( shape == 'PR' ){
						shape = 'Pear';
						imgUrl = 'http://michaeltrio.qoobx.com/skin/frontend/base/default/packer/images/diamonds/pear.png';
					} else if( shape == 'CU' ){
						shape = 'Cushion';
						imgUrl = 'http://michaeltrio.qoobx.com/skin/frontend/base/default/packer/images/diamonds/cushion.png';
					} else if( shape == 'RA' ){
						shape = 'Radiant';
						imgUrl = 'http://michaeltrio.qoobx.com/skin/frontend/base/default/packer/images/diamonds/radiant.png';
					} else if( shape == 'OV' ){
						shape = 'Oval';
						imgUrl = 'http://michaeltrio.qoobx.com/skin/frontend/base/default/packer/images/diamonds/oval.png';
					} else if( shape == 'AS' ){
						shape = 'Asscher';
						imgUrl = 'http://michaeltrio.qoobx.com/skin/frontend/base/default/packer/images/diamonds/asscher.png';
					} else if( shape == 'MQ' ){
						shape = 'Marquise';
						imgUrl = 'http://michaeltrio.qoobx.com/skin/frontend/base/default/packer/images/diamonds/marquise.png';
					}


					var elementToAppend = '<tr data-id="' + entry.importxls_id + '" class="item_ajax_get_details">' +
			                ...
			                '<td class="cell-carat">' + entry.carat + '</td>' +
			                '<td class="cell-color">' + entry.color + '</td>' +
			                '<td class="cell-clarity">' + entry.clarity + '</td>' +

			                '<td class="cell-fluorescence">' + entry.fluorescence + '</td>' +
			                ...
			                '<td class="cell-price">SGD $' + diamondPrice + ' <i class="fa fa-arrow-right pl30"></i></td>'+
						'</tr>';
				...
				if( !contentLoadingState ){
			    	...
			    	if( !ajaxStop ){
			    		...
			    		if( diamondsParamsURL.page < diamondsParamsURL.pages ){
				    		...
				    		jQuery('.loader-diamonds-results').addClass('loader-show');
				    		var requestUrl = localpath+'/diamonds/ajax/filter/';
