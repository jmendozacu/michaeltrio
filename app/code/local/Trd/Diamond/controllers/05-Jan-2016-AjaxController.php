      ...
      //  $data['currency_code'] = $_currentCurrencyCode;
        ...
        if ($ringId) {
		 ...
		 if(Mage::app()->getStore()->getCurrentCurrencyCode()=='USD'){
			 // only for usd to sgd conversation 	
			// echo $dataRng['prprice'];echo"<br>";
	//	echo $data['diamonds_price_val'] ." diamond price <br>";
	//	echo ($ringPrice*$currentRate['SGD'])." ring price <br>";
	
	
			$finalPrc = $ringPrice + Mage::helper('core')->currency($data['diamonds_price_val'],false,true) ;	
		}else{
				$finalPrc =$ringPrice +$data['diamonds_price_val'] ;
		}
		//echo Mage::helper('core')->currency($data['diamonds_price_val'],true,false);echo "<br>";
		//		echo Mage::helper('core')->currency($data['diamonds_price_val'],true,true);echo "<br>";
		//				echo Mage::helper('core')->currency($data['diamonds_price_val'],false,true);echo "<br>";
...
//                $shape_list .='<li class="level1 item nav-1-1 ' . $first . ' "> 
//                                                        <a data-value="' . strtolower($value) . '" href="javascript:;" class="unchecked">
//                                                            <img alt="" src="' . Mage::getBaseUrl() . '/media/catalog/category/Shape_' . $keyy . '.png" class="menu-thumb-small"> 
