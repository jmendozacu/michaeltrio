...
class IcoTheme_Less_Adminhtml_FileController
    extends Mage_Adminhtml_Controller_Action
{
    protected function _initAction($layoutIds=null)
    {
        $this->loadLayout($layoutIds)
            ->_setActiveMenu('icotheme/less')
            ->_title(Mage::helper('tless')->__('Manage Less Files'))
            ->_addBreadcrumb(Mage::helper('tless')->__('Manage Less Files'), Mage::helper('tless')->__('Manage Less Files'));
        return $this;
    }
    ...
    protected function _doMassAction($type)
    {
        ...
        try {
            ...
            foreach ($filesIds as $fileId) {
                $file = Mage::getModel('tless/file')->load($fileId);
