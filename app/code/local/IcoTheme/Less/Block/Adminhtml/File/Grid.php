...
class IcoTheme_Less_Block_Adminhtml_File_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $collection = Mage::getModel('tless/file')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('cache', array(
            ...
            'index'    => 'cache',
            'width'    => '10%',
            'filter'   => 'tless/adminhtml_widget_grid_column_filter_cache',
            'renderer' => 'tless/adminhtml_widget_grid_column_renderer_cache',
        ));
        ...
        $this->addColumn('custom_variables', array(
            ...
            'width'    => '30%',
            'filter'   => 'tless/adminhtml_widget_grid_column_filter_variables',
            'renderer' => 'tless/adminhtml_widget_grid_column_renderer_variables',
        ));
